...
// JSX를 사용한 것과 사용안함 것을 비교 //

// 1. JSX를 사용한 예
// 넣을 요소
const myele1 = <h1>나는 JSX를 사용하고 있어!</h1>;
// 리액트 루트생성하기 : createRoot
...
// 넣을 요소를 createElement() 메서드로 생성함(JSX 쓰지않고)
...
/***********************************************
    위 두가지 방식, JSX를 사용하거나 안쓸 수 있다

    JSX ES6 기반의 자바스크립트 언어의 확장이며
    런타임(실행될때) 시에 일반 자바스크립트로 변환된다!
...
const root5 = ReactDOM.createRoot(document.querySelectorAll("#root div")[5]);
root5.render(myele5)